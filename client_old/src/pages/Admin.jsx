...
export default function Admin() {
  ...
  if (!authed) {
    return (
      <div className="panel mx-auto mt-10 max-w-sm p-7">
        <p className="eyebrow">Restricted</p>
        <h1 className="mt-1 font-display text-3xl text-white">Admin sign-in</h1>
        <p className="mb-5 mt-1 text-sm text-muted">Enter the committee admin key.</p>
        <input
          type="password"
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="font-display text-3xl text-white sm:text-4xl">Contest console</h1>
        </div>
